...
<?
include('/var/www/html/market/seller/headermin.php');
...
$(function (){
	$("#sell_price_btn").click(function (){
  	$("#sell_price_toggle").toggle();
	$("#sell_price_btn").hide(); 
  });
});
//토글끝
...
//모델명있음없음
$(function (){
	$("#md_label1").click(function (){
  		$("#md_form").show();
		  document.getElementById('model_name').value = '';
 	});

  	$("#md_label2").click(function (){
  		$("#md_form").hide();
		document.getElementById('model_name').value = '없음';
  	});
...
function checkOnlyOne(element) {
  ...
  const checkboxes 
      = document.getElementsByName("iconidx[]");
...
function change(depth, index, target)
{
	...
	if ( depth == 1 && index != -1)  // 대분류 선택 시
	{
		...
		if ( depth2[sp_value2] != null )
		{
			...
			for(i = 1,j = 0; i <= depth2[sp_value2].length, j <= depth2[sp_value2].length-1; i++,j++ ) {
					
						f.select2.options[i] = new Option(depth2[sp_value2][j], depth2_value[sp_value2][j] + sep + sp_value2 + sep + j);
						...
						<tr>
							<td>
								<!--콘텐츠출력-->
									...
									<tr> 
										<td style="display: block !important; float: none !important;" height="75" align="center" valign="top" bgcolor="#FFFFFF" class="border_shadow menu"><br> 
										
											<table width="100%" style="border:none !important" class="table_all" id="product_info" name="product_info">
												<tr bgColor="white"> 
													<td width="20%" height="25" bgcolor="#ffffff" style="display:none; color:#178cdb; border-top: 1px solid #178cdb;" align="center" class='contenM tabletd_all td_design td_design_font'>분류 선택</td>
													<td style="border-top: 1px solid #178cdb;" class='tabletd_all tabletd_small td_design'>
														
														<div class="oolimbox-wrapper oolimbox-grid3 category_flex">
															<div class="oolimbox-col_3dan" style="text-align:center; width:45%; margin-right: 8%;">
																<span class="product_font" style="background:none;" class='ranking_bgM'>1차카테고리</span><br>
																<select name="select1" size="1" onchange='change(1, this.form.select1.selectedIndex, this.form)'  class="product_font input_design itemSelect category_select">
															...
															<div class="oolimbox-col_3dan"  style="text-align:center; width:45%;">
																<span class="product_font" style="background:none;" class='ranking_bgM'>2차카테고리</span><br>
																<select name="select2" size="1"  onchange='change(2, this.form.select2.selectedIndex, this.form)' class="product_font itemSelect input_design category_select">
																<option value="">선택</option>
																</select>
															</div>

															<div style="display:none;" class="oolimbox-col_3dan" style="text-align:center;">
																<span style="background:none;" class='ranking_bgM'>3차카테고리</span><br>
																<select name="select3" size="10" style='width:90%; border: solid 1px #707070 !important;' onchange='change(3, this.form.select3.selectedIndex, this.form)' class="itemSelect input_design">
												...
												<tr bgColor="white"> 
													<? if(!$_POST[part_code]) {?>
													<td height="25" bgcolor="#ffffff" style="color:#178cdb;" align="center" class='contenM tabletd_all td_design td_design_font'>카테고리 선택하시고 내용을 작성해주세요!</td>
													<? } ?>
													<td style="display:none;" class='tabletd_all tabletd_small td_design'><input name="part_code" type="text" maxlength="20" size="50" class="formText input_design" <?=$style->colorAlign("#FF0000 ", 0);?> readOnly value="<?if($_POST[part_code]){ echo $_POST[part_code];?><?}else{?>카테고리를 선택하세요<?}?>">&nbsp;&nbsp;( <font color="#FF0000">! 주의</font> : 카테고리 선택이 완료되면 카테고리 코드가 나타납니다.)</td>
												</tr>
												<? 
														$part_code = $_POST[part_code];
														// 카테고리 이름 출력
														$part_stat_row = $db->object("cs_part", "where part1_code='$part_code' or part2_code='$part_code' or part3_code='$part_code'");
														...
														while( $part_row = @mysqli_fetch_object( $part_result )) {
															$i++;
															$part_name.=$i."차 카테고리 <font style='margin-right:1%;' color='#1379cd'>".$part_row->part_name."</font>";
														}

														if($_POST[part_code]){
													?>
														<tr>
															<td height="25" bgcolor="#ffffff" align="center" style="text-align:center;" class='product_list_category_font'><?=$part_name;?> </td>
														</tr>
													<?}?>
												<tr style="display:none;" bgColor="white"> 
													<td height="25" bgcolor="#178cdb" style="color:#fff;" align="center" class='contenM tabletd_all'>상품코드</td>
												...
												<tr bgColor="white"> 
													...
													<td colspan="2" class='tabletd_all tabletd_small td_design input_font'>
														<table width="100%">
															<tr> 
																<td>
																	<table width="100%">
																		<tr style="display: flex; flex-direction: column; flex-wrap: wrap; margin-bottom: 10%;"> 
																			<td align="right">
																				<div id="itemtable_itemcont">
																					<div id="itemtable_itemCenter">
																						<div class="itemtable_itemCenter sensbody input_font">
																							<p class="product_font" style="padding-left:10px;">대표이미지</p>
																							<div style="text-align: center;">
																								<label for="input-file0"><img src="/img/common/estimate_icon_image_info.png" id="img_section0"></label>
																								<input style="padding-left: 5px; display:none;" name="images1" type="file" id="input-file0" class="file_text_mo2 input_font">
																								<?for($i=1;$i<=5;$i++){?>
																									<label for="input-file<?=$i?>"><img src="/img/common/estimate_icon_image_info.png" id="img_section<?=$i?>"></label>
																									<input style="display:none;" name="add_images<?=$i?>" type="file" id="input-file<?=$i?>" class="file_text_mo2">
																								<?}?>
																							</div>
																						</div>
																					</div>
															...
															<tr style="display:none;" id="itemimg1"> 
																<td>
																	<table height="25">
																		<tr> 
																			<td align="right">
															...
															<tr style="display:none;" id="itemimg2"> 
																<td>
																	<table height="25">
																		<tr> 
																			<td align="right">
												...
												<tr style="display:none;" bgColor="white"> 
													<td width="20%" height="25" bgcolor="#ffffff" style="color:#178cdb; border-bottom:none;" align="center" class='contenM tabletd_all td_design td_design_font'>추가이미지</td>
													<td style="border-bottom:none;" class='tabletd_all tabletd_small td_design input_font' colspan="2"><input type="checkbox" name="add_images_check" value="1" onClick="addImagesCheck();" checked="on"> 추가이미지 입력하기 (예: 전/후/측면/내부/외부)</td>
												</tr>
												
												<tr  bgColor="white">
													<td style="line-height: 0.5 !important;" class='border_none tabletd_all tabletd_small td_design input_font' colspan="2" ><input style="border-bottom: 1px solid #ddd !important; " placeholder="상품명 : 예) LG 냉장고 100리터" name="name" type="text" class="border_none formText input_font input_design product_font" onKeyDown="partCodeCheck();">&nbsp;</td>
												</tr>
												<tr>
													<td class='tabletd_all tabletd_small td_design input_font'>
														<div class="product_add_model">
															<p style="font-size:16px; margin-right:5%;">모델명 : </p>  
															<input class="src_radio" style="display:none;" id="md_label1" onclick="" type="radio" name="search_day" value="1" >
																<label class="src_label" for="md_label1" >있음</label>
																				
															<input class="src_radio" style="display:none;" id="md_label2" onclick="" type="radio" name="search_day" value="2" >
																<label class="src_label" for="md_label2" >없음</label>
														</div>										
													</td>
												</tr>
												<tr id="md_form"style="display:none;" bgColor="white"> 
													
													<td style="line-height: 0.5 !important;" class='tabletd_all tabletd_small td_design input_font'>
														
														<input style="border-bottom: 1px solid #ddd !important; " placeholder="모델명 : 예) ABC-1234" id="model_name" name="model_name" type="text" class="border_none formText input_font input_design product_font" >
													</td>
												</tr>												
												<?/*
												<tr bgColor="white"> 
													<td width="20%" height="25" bgcolor="#178cdb" style="color:#fff;" align="center" class='contenM tabletd_all'>간략한설명</td>
												...
												*/?>
												...
												<tr style="display:none;" bgColor="white"> 
													<td width="20%" height="25" bgcolor="#ffffff" style="color:#178cdb;" align="center" class='contenM tabletd_all td_design td_design_font'>제조회사</td>
													<td class='tabletd_all tabletd_small td_design input_font' colspan="2"><input name="company" type="text" class="formText input_font input_design">&nbsp;제조 및 판매회사를 적어 주세요</font></td>
												</tr>
												<tr bgColor="white"  style="display:none;"> 
													<td width="20%" height="25" bgcolor="#178cdb" style="color:#fff;" align="center" class='contenM tabletd_all'>가격대체</td>
												...
												<tr bgColor="white"  style="display:none;"> 
													<td width="20%" height="25" bgcolor="#178cdb" style="color:#fff;" align="center" class='contenM tabletd_all'>대체문구</td>
													<td class='tabletd_all tabletd_small' colspan="2"><input name="substtxt" type="text" class="formText">&nbsp;가격대신 표기됩니다.</td>
												</tr>
												<tr bgColor="white"  style="display:none;"> 
													<td width="20%" height="25" bgcolor="#178cdb" style="color:#fff;" align="center" class='contenM tabletd_all'>대체아이콘</td>
													<td class='tabletd_all tabletd_small' colspan="2">
														<?
												...
												<tr bgColor="white"  style="display:none;"> 
													<td width="20%" height="25" bgcolor="#178cdb" style="color:#fff;" align="center" class='contenM tabletd_all'>시중가격</td>
												...
												<tr bgColor="white">
													<td style="height:50px;" class='tabletd_all tabletd_small td_design input_font' colspan="2"><input style="border-bottom: 1px solid #ddd !important;" placeholder="판매가격 : 숫자만 입력하세요." name="shop_price" type="number" class="border_none formText input_font input_design product_font" maxlength="11" size="11" <?=$style->align(2);?> <?=$style->strCheck(0);?>></td>
												</tr>
												<tr style="display:none;" bgColor="white"> 
													
													<td style="height:50px;" class='tabletd_all tabletd_small td_design input_font' colspan="2"><input style="border-bottom: 1px solid #ddd !important;" placeholder="배송비(미 입력시 무료배송)" name="deliv_fee" type="text" class="formText input_font input_design product_font" maxlength="11" size="11" <?=$style->align(2);?> <?=$style->strCheck(0);?>></td>
												</tr>
												<tr style="display:none;" bgColor="white"> 
													<td width="20%" height="25" bgcolor="#ffffff" style="color:#178cdb;" align="center" class='contenM tabletd_all td_design td_design_font'>배송지역선택</td>
													<td class='tabletd_all tabletd_small td_design' colspan="2">
														<select style="border: solid 1px #707070 !important;" name="area1" onchange="ajaxArea2(this.value);" class="formSelect input_design">
															<option value="">선택</option>
															<?
														...
														<select style="border: solid 1px #707070 !important;" id="area2" name="area2" class="formSelect input_design">
															<option value="">선택</option>
															<!-- AJAX 내용 출력 -->
														</select> <a href="javascript:inputArea();"  class="btn_guide1 input_design">추가</a>	
														<br>
														<input name="area" type="text" class="formText input_design" style="width:90%;"  placeholder="미입력시 전국으로 표시"  readonly>
														<br>
														<a href="javascript:delArea(1);"  class="btn_guide1 input_design">비우기</a>	
													</td>
												</tr>												
												<tr bgColor="white"   style="display:none;"> 
													<td width="20%" height="25" bgcolor="#178cdb" style="color:#fff;" align="center" class='contenM tabletd_all'>묶음배송 제외</td>
												...
												<tr bgColor="white"  style="display:none;">
													<td width="20%" height="25" bgcolor="#178cdb" style="color:#fff;" align="center" class='contenM tabletd_all'>최소구매수량</td>
												...
												<tr style="display:none;" bgColor="white"> 
													<td width="20%" height="13" bgcolor="#ffffff" style="color:#178cdb;" align="center" class='contenM tabletd_all td_design td_design_font'>판매수량</td>
													<td class='tabletd_all tabletd_small td_design input_font' colspan="2"><input style="display:none;" name="unlimit" type="checkbox" value="1" onClick="goodsUnlimit()"><input name="number" style="text-align:center;"type="text" maxlength="11" size="11" class="formText input_font input_design" <?=$style->align(2);?> <?=$style->strCheck(0);?>  onClick="goodsNumber()" value="1">&nbsp;개</td>
												</tr>
												<tr bgColor="white"  style="display:none;"> 
													<td width="20%" height="25" bgcolor="#178cdb" style="color:#fff;" align="center" class='contenM tabletd_all'>포인트</td>
												...
												<? if( $admin_row->express_check==2 ) { ?>
												<tr bgColor="white"> 
													<td width="20%" height="25" bgcolor="#178cdb" style="color:#fff;" align="center" class='contenM tabletd_all'>배송가중치</td>
												...
												<?}?>
												<tr style="display:none;" bgColor="white"> 
													<td bgcolor="#178cdb" style="color:#fff;"width="20%" height="25" align="center" bgcolor='F3DBDB' class='contenM'>상품 옵션</td>
												...
												<tr style="display:none;" bgColor="white"> 
													<td width="20%" bgcolor="#ffffff" style="color:#178cdb;" align="center" class='contenM tabletd_all td_design td_design_font'>상품이미지<br>자동리사이징</td>
													<td height="35" colspan="2" class='tabletd_all tabletd_small td_design input_font'>
														<input type="checkbox" name="resize" value="1" onclick="resizecheck()" checked="on"> 선택시 상품이미지의 기본이미지를 기준으로 자동 리사이징이 됩니다. 
													</td>
												</tr>
												
												<tr style="display:none;" bgColor="white" > 
													<td width="20%" height="25" bgcolor="#ffffff" style="color:#178cdb; display:none;" align="center" class='contenM tabletd_all td_design td_design_font'>상품상태</td>
													<td style="height:50px;" class='priduct_icon_flex tabletd_all tabletd_small td_design' colspan="2">
														<?
														$notice_result		= $db->select("cs_icon_list", "where code=1 order by idx asc" );
														while( $iconRow = mysqli_fetch_object($notice_result) ) {
														?>
															<input onclick='checkOnlyOne(this)' type=checkbox name='iconidx[]' value='<?=$iconRow->idx?>'> <img style="height:22px;"src="../../data/designImages/<?=$iconRow->icon?>" alt="<?=$iconRow->name?>">&nbsp;
														<?}?>
													</td>
												</tr>
												<tr style="display:none;" bgColor="white"> 
													<td width="20%" height="25" bgcolor="#ffffff" style="color:#178cdb;" align="center" class='contenM tabletd_all td_design td_design_font'>태그</td>
													<td class='tabletd_all tabletd_small td_design input_font' colspan="2"><input name="tag" type="text"  style="width:90%;" class="formText input_font input_design"></td>
												</tr>
												<tr id="product_info2" name="product_info2"> 
													<td width="20%" height="25" bgcolor="#ffffff" style="color:#178cdb; display:none;" align="center" class='contenM tabletd_all td_design td_design_font'>상품상세설명</td>
													<td class='sensO tabletd_all td_design input_font'>
													<p class="product_font" style="padding-left:10px;">상품설명</p>
															<textarea class="product_add_con" id="content" name="content" placeholder="1.상세정보 2.배송가능지역 3.배송비&#13;&#10;예) 2022년 LG 냉장고 / 서울배송가능 그외지역 문의 또는 배송비 추가발생"></textarea>
															<!-- 에디터를 화면에 출력합니다. -->
												...
												<tr bgColor="white"  style="display:none;"> 
													<td bgcolor="#178cdb" style="color:#fff;"height="25" align="center" class='contenM tabletd_all'>파일 등록</td>
									...
									<tr id="product_info2" name="product_info2"> 
										<td align="center" valign="top" bgcolor="#FFFFFF" class="menu"  style="display:none"><br> 
											...
											<table width="100%" class="table_all">
												<tr bgColor="white"> 
													<td width="20%" bgcolor="#178cdb" style="color:#fff;" align="center" class='contenM tabletd_all'>노출형태</td>
												...
												<tr bgColor="white"> 
													<td width="20%" bgcolor="#178cdb" style="color:#fff;" align="center" class='contenM tabletd_all'>관련상품</td>
													<td height="35" colspan="2" class='tabletd_all tabletd_small'>
												...
												<tr bgColor="white" id="subitemsystem" style="display:none"> 
													<td width="20%" bgcolor="#178cdb" style="color:#fff;"height="25" align="center" class='contenM tabletd_all'>상품선택</td>
										...
										<td align="center" valign="top" bgcolor="#FFFFFF" class="menu"><br> 
											...
											<table style="display:none;" width="100%" class="table_all">
												<tr bgColor="white">
													...
													<br><br>
													<a href="javascript:fieldlistAdd()"class='search_bbs3'>항목추가 ▼</a> <a style="background: #f79646;" href="javascript:fieldlistRemove()"class='search_bbs1'>항목제거 ▼</a>
													</td>
												</tr>
												<tr>
													<td width="30%" height="25" class='contenM tabletd_all' style="color:#fff;" bgcolor="#178cdb">항목이름</td>
													<td width="70% "height="25" class='contenM tabletd_all' style="color:#fff;" bgcolor="#178cdb">내용</td>
												</tr>
												<?for($i=0;$i<$DEFAULTADDFIELD;$i++){
													...
													<td height="25" class='contenM tabletd_all'>
														...
														<fieldset>
															<table>
																...
																<tbody>
																	<tr>
																		<td style="width: 100%;"><div class="box" style='height:50px'><textarea name="fielddata[]" style='height:50px'><?=$fieldArr2[1]?></textarea></div></td>
																	</tr>
																</tbody>
															</table>
														</fieldset>
											...
											<table style='margin:0 auto;' id="product_info3" name="product_info3">
												<tr>
													<td height='70'><a href="javascript:sendit();" class='product_fix_btn oolimbtn-botton1'>등록</a></td>
												</tr>
											</table>
										</td>
									</tr>
...
<script>
	<?for($i=0; $i<=5; $i++){ ?>
		const reader<?=$i?> = new FileReader();

        reader<?=$i?>.onload = (readerEvent) => {
            document.querySelector("#img_section<?=$i?>").setAttribute("src", readerEvent.target.result);
        };

        document.querySelector("#input-file<?=$i?>").addEventListener("change", (changeEvent) => {

            const imgFile<?=$i?> = changeEvent.target.files[0];
            reader<?=$i?>.readAsDataURL(imgFile<?=$i?>);
