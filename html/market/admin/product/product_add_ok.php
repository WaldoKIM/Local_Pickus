...
if( $tools->chkDigit($_POST[part_code] )) {
	...
	$sql = "part_idx=$part_row->idx, display='$_POST[display]', subitem='$_POST[subitem]', subitemtarget='$_POST[subitemtarget]', itemlist='$_POST[itemlist]', tag='$_POST[tag]', 
			description='$_POST[description]', code='$_POST[code]', subst='$_POST[subst]', substtxt='$_POST[substtxt]', resize='$_POST[resize]', substimg='$iconlist2', name='$_POST[name]', 
			iconidx='$iconlist', company='$_POST[company]', old_price='$_POST[old_price]', shop_price=$_POST[shop_price], mincnt='$_POST[mincnt]', unlimit=$_POST[unlimit], 
			number=$_POST[number], point='$_POST[point]', box=$_POST[box], opt_data='$Optdata', images1='$images1', images2='$images2', images3='$images3', add_images1='$add_images1', 
			...
			content='$_POST[content]', register=now(), ranking = $ranking, fieldname1='$addfieldname1', fielddata1='$addfielddata1', fieldname2='$addfieldname2', fielddata2='$addfielddata2', 
			fieldname3='$addfieldname3', fielddata3='$addfielddata3', fieldname4='$addfieldname4', fielddata4='$addfielddata4', fieldname5='$addfieldname5', fielddata5='$addfielddata5', 
			fieldname6='$addfieldname6', fielddata6='$addfielddata6', fieldname7='$addfieldname7', fielddata7='$addfielddata7', fieldname8='$addfieldname8', fielddata8='$addfielddata8', 
			fieldname9='$addfieldname9', fielddata9='$addfielddata9', fieldname10='$addfieldname10', fielddata10='$addfielddata10', fieldname11='$addfieldname11', fielddata11='$addfielddata11', 
			fieldname12='$addfieldname12', fielddata12='$addfielddata12', fieldname13='$addfieldname13', fielddata13='$addfielddata13',  fieldname14='$addfieldname14', fielddata14='$addfielddata14', 
			fieldname15='$addfieldname15', fielddata15='$addfielddata15', area='$_POST[area]', model_name='$_POST[model_name]', deliv_fee='$_POST[deliv_fee]', deliv_exc='$_POST[deliv_exc]'  ";

	if( $db->insert("cs_goods", $sql) ) { $tools->javaGo("product_add.php"); } else { $tools->errMsg('비상적으로 입력 되었습니다.');}
