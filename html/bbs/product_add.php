...
<div class="member com_pd">
	<div class="container">
		...
		<div class="sub_title">
			<h1 class="main_co htitle">상품 등록</h1>
			<p class="tit_desc hdesc">피커스 마켓 상품 관리 및 등록을 하실 수 있습니다.</p>
		</div>
		<div class="tab_area">
		<ul class="tab mb-5">
                <li class="col-lg-1 col-xs-0 vhidden" style="border-bottom: 1px solid #ececec  !important;">
                </li>
				<li class="col-lg-4 col-xs-6 main_bg on" style="border-bottom: 1px solid #ececec  !important;">
					<a href="./product_add.php">
						<h4>상품 등록</h4>
					</a>
				</li>
                <li class="col-lg-2 col-xs-0 vhidden" style="border-bottom: 1px solid #ececec  !important;">
                </li>
				<li class="col-lg-4 col-xs-6" style="border-bottom: 1px solid #ececec  !important;">
			...
			<a href="#." data-toggle="modal" data-target="#esti_guide" class="guide_estimate" style="color:#000"><i class="xi-help main_co"></i> 정산 가이드</a>
        ...
        include('../market/seller/product/product_addmin.php');?>
	</div><!-- container -->
</div><!-- member -->
