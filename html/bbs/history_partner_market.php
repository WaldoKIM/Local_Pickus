...
<div class="member com_pd">
	<div class="container">
		...
		<div class="sub_title">
			<h1 class="main_co htitle">정산내역</h1>
			<p class="tit_desc hdesc">정산내역을 확인하실 수 있습니다.</p>
		</div>
		<div class="tab_area">
		<ul class="tab mb-5">
				...
				<li class="col-lg-3 col-xs-4 main_bg on m050025" style="border-bottom: 1px solid #ececec  !important;">
        ...
        include('../market/seller/wallet/walletmin.php');?>
	</div><!-- container -->
</div><!-- member -->
