        ...
        ?>
            ...
            <ul class="login row main_bg">
                ...
                <?php if ($member['mb_level'] == 0 || $member['mb_level'] == 10) { ?>
                    ...
                    <li class="col-xs-6"><a class="line_bg " href="/bbs/history_member.php">정산내역</a></li>
                <?php } ?>
                <?php if ($member['mb_level'] == 2) { ?>
                ...
                <?php } ?>
                <?php if ($member['mb_level'] == 10) { ?>
                    <li class="col-xs-6"><a class="line_bg" href="/adm">관리자</a></li>
                <?php } ?>
                ...
                <?php if (($member['mb_level'] == 2) || ($member['mb_level'] == 10)) : ?>
                    ...
                    <li class="col-xs-6"><a class="line_bg" href="/bbs/history_partner.php">정산내역</a></li>
                <?php endif; ?>
            </ul>
        <?php
        }
    ...
    <ul class="nav" id="nav-left">
        <?php if ($is_member) { ?>
            ...
            <?php if (($member['mb_level'] == 2) || ($member['mb_level'] == 10)) : ?>
                ...
                <li><a href="../market/seller/order/trade.php">판매자센터</a></li>
            <?php endif; ?>
        ...
        <?php if ($member['mb_level'] != 2) : ?>
            ...
            <li style="display:none !important;"><a href="../market">피커스마켓</a></li>
        <?php endif; ?>
                ...
                <ul class="top_right">
                    ...
                    <ul>
                        ...
                        ?>
                            ...
                            <?php if ($member['mb_level'] == 0 || $member['mb_level'] == 10) { ?>
                                <li><a class="small_nav" href="/bbs/mypage.php">마이페이지</a></li>
                                <li><a class="small_nav" href="/bbs/history_member.php">정산내역</a></li>
                            <?php } ?>

                            <?php if ($member['mb_level'] == 2) { ?>
                                <li><a class="small_nav" href="/bbs/mypage_partner.php">마이페이지</a></li>
                                <li><a class="small_nav" href="/market/main/index.php">피커스 마켓</a></li>
                            <?php } ?>
                            <?php if ($member['mb_level'] == 8) { ?>
                                <li><a class="small_nav" href="/bbs/mypage_guest.php">마이페이지</a></li>
                                <li><a class="small_nav" href="/bbs/history_member.php">정산내역</a></li>
                            <?php } ?>
                            <li><a class="small_nav" href="/bbs/notify.php">알림<?php
                                                            if ($notify_cnt) {
                ...
                <li class="td this_gnb">
                    ...
                    <div class="gnb_menu">
                        <ul style="display: flex;flex-direction: row;flex-wrap: nowrap;"class="myMenu">
                            <?php if ($is_member) : ?>
                                <?php if ($member['mb_level'] == 0 || $member['mb_level'] == 10 || $member['mb_level'] == 8) : ?>
                                    <li><a class="btn" href="/estimate/my_estimate_list.php"><span class="tx">내 신청현황</span></a>
                                        <ul style="width:100%;"class="submenu">
                                            <li><a href="/estimate/my_estimate_list.php" class="">매입/철거</a></li>
                                            <li><a href="/estimate/my_estimate_list_match.php" class="">구매</a></li>
                                        </ul>
                                    </li>
                                <?php endif; ?>
                            <?php endif; ?>
                            <?php if ($member['mb_level'] == 2 || $member['mb_level'] == 10) : ?>
                                <li><a class="btn" href="/estimate/estimate_list2.php"><span class="tx">매입&#47;철거</span></a>
                                    <ul class="submenu">
                                    <li><a href="/estimate/estimate_list2.php" class="">매입&#47;철거 전체 견적</a></li>
                                    <li><a href="/estimate/estimate_list1.php" class="">맞춤</br>추천 견적</a></li>
                                    <li><a href="/estimate/partner_estimate_list.php?gubun=1" class="">매입 참여 견적</a></li>
                                    <li><a href="/estimate/partner_estimate_list.php?gubun=2" class="">매입 연결 견적</a></li>
                                </ul>
                                </li>
                                <li><a class="btn" href="/estimate/estimate_list3.php"><span class="tx">바로 판매</span></a>
                                    <ul class="submenu">
                                    <li><a href="/estimate/partner_estimate_list3.php" class="">바로 판매 전체 견적</a></li>
                                    <li><a href="/estimate/partner_estimate_list.php?gubun=4" class="">판매 참여 견적</a></li>
                                    <li><a href="/estimate/partner_estimate_list.php?gubun=5" class="">판매 연결 견적</a></li>
                                    <li><a href="/estimate/partner_estimate_list.php?gubun=8" class="">판매 배송 내역</a></li>
                                    </ul>
                                </li>
                                <li><a class="btn" href="/estimate/partner_estimate_connect.php"><span class="tx">연결 내역</span></a>
                                    <ul class="submenu">
                                    <li><a href="/estimate/partner_estimate_connect.php" class="">매입&#47;철거 고객 연결</a></li>
                                    <li><a href="/estimate/partner_estimate_connect.php?gubun=5" class="">바로 판매 고객 연결</a></li>
                                    <li><a href="/estimate/partner_estimate_connect.php?gubun=9" class="">마켓</br>고객 연결</a></li>
                                    </ul>
                                </li>
                                <li><a class="btn" href="/estimate/partner_estimate_list.php?gubun=3"><span class="tx">고객 관리</span></a>
                                    <ul class="submenu">
                                    <li><a href="/estimate/partner_estimate_list.php?gubun=3" class="">매입 관련 문의&#47;후기</a></li>                                    
                                    <li><a href="/estimate/partner_estimate_list.php?gubun=7" class="">판매 관련 문의&#47;후기</a></li>
                                    <li><a href="/estimate/partner_estimate_list.php?gubun=11" class="">마켓 관련 문의&#47;후기</a></li>                                    
                                    </ul>
                                </li>
                                <li><a class="btn" href="/bbs/history_partner.php"><span class="tx">정산 관리</span></a>
                                    <ul class="submenu">
                                    <li><a href="/bbs/history_partner.php" class="">매입&#47;철거 정산 내역</a></li>
                                    <li><a href="/bbs/history_partner_match.php" class="">바로 판매 정산 내역</a></li>
                                    <li><a href="/bbs/history_partner_market.php" class="">마켓</br>정산 내역</a></li>
                                    </ul>
                                </li>
                                <li><a class="btn" href="/bbs/product_add.php"><span class="tx">상품 등록&#47;관리</span></a></li>
                                <li><a class="btn" href="/market/seller/order/trade.php"><span class="tx">주문 관리</span></a></li>
                                <li><a class="btn" href="/bbs/wallet_settle.php"><span class="tx">출금 신청 내역</span></a></li>
                            <?php endif; ?>
                            <?php if ($member['mb_level'] != 2) : ?>
                                <li><a href="/estimate/estimate_register.php" class="btn"><span class="tx">견적 신청</span></a>
                                <ul class="submenu">
                                    <li><a href="/estimate/estimate_register1B.php" class="">가전/가구 판매</a></li>
                                    <li><a href="/estimate/estimate_register2D.php" class="">다량판매</a></li>
                                    <li><a href="/estimate/estimate_register3B.php" class="">철거/원상복구</a></li>
                                    <li><a href="/estimate/estimate_register4.php" class="">기업전용</a></li>
                                    <li><a href="/estimate/estimate_match.php" class="">중고구매매칭</a></li>
                                </ul>
                                </li>                                
                            <?php endif; ?>
  
                            <!--
                                <li style="display:none !important;"><a href="../market" class="btn"><span class="tx">피커스마켓</span></a></li>
                            -->
                            <?php if ($member['mb_level'] == 10) : ?>
                            <!-- 
